...
def main():
    ...
    for structure in structure_list:
        ...
        for structure_file in structure_files:
            ...
            input_CW_file = os.path.join(sequence_path, f"{structure_name}_SEQRES_ATOM.fa")
            output_CW_file = os.path.join(sequence_path, f"{structure_name}_SEQRES_ATOM_ClustalO.fa")
